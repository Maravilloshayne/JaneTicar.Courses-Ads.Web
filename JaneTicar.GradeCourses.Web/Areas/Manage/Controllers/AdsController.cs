...
using JaneTicar.GradeCourses.Web.Areas.Manage.ViewModels.Ads;
...
namespace JaneTicar.GradeCourses.Web.Areas.Manage.Controllers
{
    ...
    public class AdsController : Controller
    {
        ...
        [HttpGet, Route("/manage/ads/update-title/{threadId}")]
        ...
        public IActionResult UpdateTitle(UpdateTitleViewModel model)
        {
            ...
            if (ad != null)
            {
                ...
                ad.TemplateName = model.TemplateName;
        ...
        public async Task<IActionResult> Thumbnail(ThumbnailViewModel model)
        {
            ...
            var dirPath = _env.WebRootPath + "/ads/" + model.AdId.ToString();
