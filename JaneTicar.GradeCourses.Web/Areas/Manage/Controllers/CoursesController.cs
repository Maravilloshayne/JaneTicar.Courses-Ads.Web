...
using JaneTicar.GradeCourses.Web.Areas.Manage.ViewModels.Courses;
...
namespace JaneTicar.GradeCourses.Web.Areas.Manage.Controllers
{
    ...
    public class CoursesController : Controller
    {
        ...
        public IActionResult Unpublish(CourseIdViewModel model)
        {
        ...
        [HttpGet, Route("/manage/courses/update-description/{coursesId}")]
        public IActionResult UpdateDescription(Guid? coursesId)
        {
            var course = this._context.Courses.FirstOrDefault(p => p.Id == coursesId);
        ...
        [HttpPost, Route("/manage/courses/update-description/")]
        ...
        public async Task<string> AttachImage(AttachImageViewModel model)
        {
            ...
            var dirPath = _env.WebRootPath + "~/threads/" + model.CourseId.ToString();
