...
namespace JaneTicar.GradeCourses.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          .AddCookie(options =>
          {
              ...
              options.Cookie.Name = "JaneTicar.GradeCourses.Web";
          });
            ...
            services.AddDbContext<DefaultDbContext>(options => options.UseMySql(Configuration.GetConnectionString("DefaultDbContextMySQL"), m => m.MigrationsAssembly("JaneTicar.GradeCourses.Web")));
